class ProfessionalsController < ApplicationController
  ...
  private
    ...
    def professional_params
      params.require(:professional).permit(:firstname, :lastname, :phone, :license, :firmname, :address, :email, :photo, :description, :established, :returncurrentmonth, :return1year, :return3years, :return5years, :totalassets, :minimumamount, :volatility, :sharperatio, :standartdeviation, :beta)
    end
end
